export default  [
    {
        ...
        aiPrompt:'Please ignore the previous reponse. Give me 5 blog topic idea in bullet wise only based on given niche & outline and give me result in Rich text editor format',
